    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseAbsensi"
                    aria-expanded="true" aria-controls="collapseAbsensi">
                    <i class="fas fa-fw fas fa-user-friends	"></i>
                    <span>Absensi</span>
                </a>
                <div id="collapseAbsensi" class="collapse show" aria-labelledby="headingAbsensi"
                    data-parent="#accordionSidebar">
                    <div class="py-2 collapse-inner rounded">
                        <a class="collapse-item" href="admin_histori_absensi.php">Histori Absensi</a>
                        <a class="collapse-item active" href="admin_edit_absensi.php">Edit Absensi</a>
                    </div>
                </div>
            </li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group row">
                                        <label for="inputMK" class="col-xl-4 col-form-label">Mata Kuliah</label>
                                        <div class="col-xl-8">
                    ...
                    <table id="example" class="display cell-border " style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>08.15</td>
                                <td>-</td>
                                <td><a class="btn btn-success btn-sm" href="admin_edit_absensi_edit.php" style="width: 90px">Edit</a></td>                           
                            </tr>
                            <tr>
                                <td>2024-02-02</td>
                                ...
                                <td>08.15</td>
                                <td>07.50</td>
                                <td><a class="btn btn-success btn-sm" href="" style="width: 90px">Edit</a></td>                           
                            </tr>
                            <tr>
                                <td>2024-02-02</td>
                                <td>Zian Carlos</td>
