                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <hr>
                                            <div>
                                                <a href="" class="text-xs font-weight-normal text-primary mb-1">View Details</a>
                                                <span class="fas fa-angle-right	sidebar-dashboard text-primary" style="float: right;"></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
