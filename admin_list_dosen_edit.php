                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="form-group row">
                                            <label for="inputNIM" class="col-sm-2 col-form-label">NIP</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputNIM">
                                            </div>
                                        </div>
                                        <input type="button" onclick="location.href='admin_list_dosen.php'" value="Simpan" class="btn btn-primary tambah_btn" />
                                    </form>
                                </div>
                            </div>
                        </div>
