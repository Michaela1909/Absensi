    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseDosen"
                    aria-expanded="true" aria-controls="collapseDosen">
                    <i class="fas fa-fw fas fa-user-alt	"></i>
                    <span>Dosen</span>
                </a>
                <div id="collapseDosen" class="collapse show" aria-labelledby="headingDosen" data-parent="#accordionSidebar">
                    <div class="py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="admin_list_dosen.php">List Dosen</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Detail Mata Kuliah Dosen</h1>
                    <table id="example" class="display cell-border" style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>2024-02-02 s/d 2024-04-30</td>
                                ...
                                <td style="display: flex; gap: 5px;">
                                    <a class="btn btn-success btn-sm" href="" style="width: 90px">Edit</a>                                
                            ...
                            <tr>
                                ...
                                <td>11.45</td>
                                <td style="display: flex; gap: 5px;">
                                    <a class="btn btn-success btn-sm" href="admin_list_MK_edit.php" style="width: 90px">Edit</a>                                
                                    <a class="btn btn-danger btn-sm" href="" style="width: 90px">Non Aktif</a>
                                </td>
                            </tr>                 
                        </tbody>
