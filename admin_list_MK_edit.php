    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseMK"
                    aria-expanded="true" aria-controls="collapseMK">
                    <i class="fas fa-fw fa-user-friends	"></i>
                    <span>Mata Kuliah</span>
                </a>
                <div id="collapseMK" class="collapse show" aria-labelledby="headingMK"
                    data-parent="#accordionSidebar">
                    <div class="py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="admin_list_MK.php">List Mata Kuliah</a>
                                ...
                                <div class="card-body">
                                    <form>
                                        <div class="form-group row">
                                            <label for="inputTglMulai" class="col-sm-3 col-form-label">Tanggal Mulai Mata Kuliah</label>
                                            <div class="col-sm-9">
                                                <input type="date" class="form-control" id="inputTglMulai">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputTglSelesai" class="col-sm-3 col-form-label">Tanggal Selesai Mata Kuliah</label>
                                            <div class="col-sm-9">
                                                <input type="date" class="form-control" id="inputTglSelesai">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputAngkatan" class="col-sm-3 col-form-label">Tahun Angkatan</label>
                                            <div class="col-sm-9">
                                        ...
                                        <input type="button" onclick="location.href='admin_list_MK.php'" value="Simpan" class="btn btn-primary tambah_btn" />
                                    </form>
                                </div>
                            </div>
                        </div>
