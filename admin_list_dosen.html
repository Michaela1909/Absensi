                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="display: flex; gap: 5px;">
                                    <a class="btn btn-success btn-sm" href="admin_list_dosen_detail.php" style="width: 90px">Detail</a>
                                    <a class="btn btn-primary btn-sm" href="admin_list_dosen_edit.php" style="width: 90px">Edit</a>
