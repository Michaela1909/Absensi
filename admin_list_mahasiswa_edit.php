...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <img src="img/UPH-White.png" alt="" class="logo-image">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="#" data-toggle="collapse" data-target="#collapseMhs"
                    aria-expanded="true" aria-controls="collapseMhs">
                    <i class="fas fa-fw fa-user-friends	"></i>
                    <span>Mahasiswa</span>
                </a>
                <div id="collapseMhs" class="collapse show" aria-labelledby="headingMhs" data-parent="#accordionSidebar">
                    <div class="py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="admin_list_mahasiswa.php">List Mahasiswa</a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseMK"
                    aria-expanded="true" aria-controls="collapseMK">
                    <i class="fas fa-fw fa-user-friends	"></i>
                    <span>Mata Kuliah</span>
                </a>
                <div id="collapseMK" class="collapse" aria-labelledby="headingMK"
                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputNIM" value="01081210011">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputSemester" class="col-sm-2 col-form-label">Saat ini Semester</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputSemester" value="8">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputAngkatan" class="col-sm-2 col-form-label">Tahun Angkatan</label>
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="inputAngkatan" value="2021">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <input type="button" onclick="location.href='admin_list_mahasiswa.php'" value="Simpan" class="btn btn-primary tambah_btn" />
                                    </form>
                                </div>
                            </div>
                        </div>
